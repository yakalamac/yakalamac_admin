(function () {
    var t, e, n, r, s, o, i, a, u, c, l, p, h, f, d, g, m, y, v, w, b, k, S, q, L, x, T, R, P, E, M, j, A, N, O, _, F,
        C, U, W, X, D, H, I, z, G, B, J, K = [].slice, Q = {}.hasOwnProperty, V = function (t, e) {
            function n() {
                this.constructor = t
            }
    ...
    for (b = {
        ...
        var t, e, n, r, s, o, i;
        for (e = arguments[0], o = 0, i = (r = 2 <= arguments.length ? K.call(arguments, 1) : []).length; i > o; o++) if (n = r[o]) for (t in n) Q.call(n, t) && (s = n[t], null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? k(e[t], s) : e[t] = s);
        return e
    }, m = function (t) {
        var e, n, r, s, o;
    ...
    u = function (t) {
        ...
        var e, n, r, s;
        for (n = 0, r = (s = E.ajax.ignoreURLs).length; r > n; n++) if ("string" == typeof (e = s[n])) {
    ...
    }), p = {ajax: t, elements: r, document: n, eventLag: o}, (R = function () {
        var t, n, r, s, o, i, a, u;
        ...
        return c.running = !0, y.render(), t = P(), v = !1, g = A(function (e, n) {
            ...
            for (100 - y.progress, s = d = 0, o = !0, u = g = 0, w = C.length; w > g; u = ++g) for (F = C[u], f = null != N[u] ? N[u] : N[u] = [], l = m = 0, b = (a = null != (k = F.elements) ? k : [F]).length; b > m; l = ++m) i = a[l], o &= (p = null != f[l] ? f[l] : f[l] = new h(i)).done, p.done || (s++, d += p.tick(e));
