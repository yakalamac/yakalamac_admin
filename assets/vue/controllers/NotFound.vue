        ...
        <div class="row pt-5">
          <div class="col-lg-12">
            <div class="text-center error-pages">
              ...
              <p class="error-message text-white text-uppercase">SORRY, AN ERROR HAS OCCURED, REQUESTED PAGE NOT FOUND!
              </p>

              <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                <a href="index.html" class="btn btn-grd-danger rounded-5 px-4"><i class="bi bi-house-fill me-2"></i>Go
                  To Home</a>
