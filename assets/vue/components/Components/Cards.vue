    ...
    <main class="main-wrapper">
        <div class="main-content">
            <div class="row row-cols-1 row-cols-xl-2">
                        ...
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4 border-end">
                                <div class="p-3 align-self-center">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/09.png" class="w-100 rounded-start" alt="...">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">New iPhone Pro Max</h5>
                                    <p class="card-text">Richard McClintock, a Latin professor at Hampden-Sydney College
                                        in Virginia All
                                    ...
                                    <div class="mt-4 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <div class="dropdown position-relative">
                                                <a href="javascript:;"
                                                    class="sharelink dropdown-toggle dropdown-toggle-nocaret"
                ...
                <div class="col">
                    <div class="card rounded-4">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/11.png" class="w-100 rounded-start" alt="...">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/12.png" class="w-100 rounded h-100" alt="...">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <a href="javascript:;" class="sharelink border" data-bs-toggle="modal"
                                                data-bs-target="#linkShareModal"><i
                                                    class="material-icons-outlined">share</i></a>
                                        </div>
                    ...
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end align-items-stretch">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/10.png" class="w-100 rounded h-100" alt="...">
                                </div>
                            </div>
                ...
                <div class="col">
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/20.png" class="img-fluid card-img-top" alt="">
                        <div class="card-body p-4">
                            ...
                            <div class="my-4 text-center">
                                ...
                                <a href="javascript:;" class="btn btn-grd btn-grd-danger border-0 btn-lg px-5">Start
                                    Exploring</a>
                            </div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="row row-cols-1 row-cols-lg-2 g-4">
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/21.png" class="img-fluid rounded" alt="">
                                            <h5 class="mb-0 mt-3">Logo Design</h5>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/22.png" class="img-fluid rounded" alt="">
                                            <h5 class="mb-0 mt-3">Whiteboard & Animated</h5>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/23.png" class="img-fluid rounded" alt="">
                                            <h5 class="mb-0 mt-3">Voice Over</h5>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/24.png" class="img-fluid rounded" alt="">
                                            <h5 class="mb-0 mt-3">Wordpress</h5>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/25.png" class="img-fluid rounded" alt="">
                                            <h5 class="mb-0 mt-3">Articles & Blog Posts</h5>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/gallery/26.png" class="img-fluid rounded" alt="">
                ...
                <div class="col">
                                ...
                                <div class="col">
                                    <div class="card shadow-none bg-grd-voilet mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/01.png" class="position-absolute end-0 bottom-0"
                                                width="140" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-grd-primary mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/02.png" class="position-absolute end-0 bottom-0"
                                                width="90" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-grd-success mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/03.png" class="position-absolute end-0 bottom-0"
                                                width="120" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-grd-danger mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/04.png"
                                ...
                                <div class="col">
                                    <div class="card shadow-none bg-grd-deep-blue mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/05.png" class="position-absolute end-0 bottom-0"
                                                width="130" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-grd-warning mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/06.png"
                    ...
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/15.png" class="card-img" alt="...">
                        <div class="card-img-overlay">
                            <p class="mb-4 text-white text-uppercase">Travel</p>
                            <h3 class="card-title text-white">Various versions evolved</h3>
                            <p class="mb-0 text-white">It was popularised in the 1960s with the release of Letraset
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="card rounded-4">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/16.png" class="card-img rounded-4" alt="...">
                            <div class="card-img-overlay">
                        ...
                        <div class="card rounded-4">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/17.png" class="card-img rounded-4" alt="...">
                            <div class="card-img-overlay">
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                <div class="col">
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/01.png" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/02.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Stay at home</h5>
                            <p class="card-text">Nam libero tempore, cum soluta nobis est
                                eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus,
                ...
                <div class="col">
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/03.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Stay at home</h5>
                            <p class="card-text">Nam libero tempore, cum soluta nobis est
                                eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus,
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/05.png" class="w-100 mb-4 rounded" alt="...">
                            <h5 class="card-title mb-4">Why do we use it?</h5>
                            <p class="card-text mb-4">Many desktop publishing packages and web page editors now use
                                Lorem Ipsum.</p>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/06.png" class="w-100 mb-4 rounded" alt="...">
                            <h5 class="card-title mb-4">Why do we use it?</h5>
                            <p class="card-text mb-4">Many desktop publishing packages and web page editors now use
                                Lorem Ipsum.</p>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/08.png" class="w-100 mb-4 rounded" alt="...">
                            <h5 class="card-title mb-4">Why do we use it?</h5>
                            <p class="card-text mb-4">Many desktop publishing packages and web page editors now use
                                Lorem Ipsum.</p>
            ...
            <div class="row g-4">
                <div class="col-12 col-xl-4">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="position-relative">
                                <img src="../../../../assets/bootstrap/assets/images/gallery/14.png" class="img-fluid rounded" alt="">
                                <div class="position-absolute top-100 start-50 translate-middle">
                                    <img src="../../../../assets/bootstrap/assets/images/avatars/05.png" width="100" height="100"
                ...
                <div class="col-12 col-xl-4">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="position-relative">
                                <img src="../../../../assets/bootstrap/assets/images/gallery/18.png" class="img-fluid rounded" alt="">
                                <div class="position-absolute top-100 start-50 translate-middle">
                                    <img src="../../../../assets/bootstrap/assets/images/avatars/02.png" width="100" height="100"
                ...
                <div class="col-12 col-xl-4">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="position-relative">
                                <img src="../../../../assets/bootstrap/assets/images/gallery/19.png" class="img-fluid rounded" alt="">
                                <div class="position-absolute top-100 start-50 translate-middle">
                                    <img src="../../../../assets/bootstrap/assets/images/avatars/04.png" width="100" height="100"
                            ...
                            <div class="row row-cols-1 row-cols-lg-2 g-3">
                                <div class="col">
                                    <div class="card shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="text-center">
                                                <img src="../../../../assets/bootstrap/assets/images/avatars/07.png" width="100" height="100"
                                ...
                                <div class="col">
                                    <div class="card shadow-none border mb-0">
                                        <div class="card-body">
                                            <div class="text-center">
                                                <img src="../../../../assets/bootstrap/assets/images/avatars/08.png" width="100" height="100"
                                                    class="rounded-circle raised bg-white" alt="">
                                            </div>
                                            <div class="text-center mt-4">
                            ...
                            <div class="row row-cols-1 row-cols-lg-2 g-3">
                                <div class="col">
                                    <div class="card shadow-none border mb-0 bg-grd-primary">
                                        <div class="card-body">
                                            <div class="text-center">
                                                <img src="../../../../assets/bootstrap/assets/images/avatars/11.png" width="100" height="100"
                                ...
                                <div class="col">
                                    <div class="card shadow-none border mb-0 bg-grd-info">
                                        <div class="card-body">
                                            <div class="text-center">
                                                <img src="../../../../assets/bootstrap/assets/images/avatars/12.png" width="100" height="100"
                                                    class="rounded-circle raised bg-white p-1" alt="">
                                            </div>
                                            <div class="text-center mt-4">
                                                <h5 class="mb-2 text-white">Andreo Simonds</h5>
