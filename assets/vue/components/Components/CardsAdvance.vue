    ...
    <main class="main-wrapper">
        <div class="main-content">
            <div class="row row-cols-1 row-cols-xl-2">
                    ...
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/09.png"
                ...
                <div class="col">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/11.png"
                                        class="w-100 rounded-start" alt="...">
                                </div>
                            </div>
                            <div class="col-md-8">
                ...
                <div class="col">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/12.png"
                ...
                <div class="col">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                <div class="p-3">
                                    <img src="../../../../assets/bootstrap/assets/images/gallery/10.png"
                                        class="w-100 rounded h-100" alt="...">
                                </div>
                            </div>
                            <div class="col-md-8">
                ...
                <div class="col">
                    <div class="card">
                        <img src="../../../../assets/bootstrap/assets/images/gallery/13.png"
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="row row-cols-1 row-cols-lg-2 g-4">
                                    ...
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/orders/02.png"
                                                class="img-fluid rounded" alt="">
                                    ...
                                    <div class="col">
                                        <div class="text-center">
                                            <img src="../../../../assets/bootstrap/assets/images/orders/06.png"
                                                class="img-fluid rounded" alt="">
                ...
                <div class="col">
                                ...
                                <div class="col">
                                    <div class="card shadow-none bg-voilet mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/01.png"
                                                class="position-absolute end-0 bottom-0" width="140" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-success mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/02.png"
                                                class="position-absolute end-0 bottom-0" width="90" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card shadow-none bg-dark-blue mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/03.png"
                                                class="position-absolute end-0 bottom-0" width="120" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <div class="card shadow-none bg-orange mb-0" style="height: 160px;">
                                        <div class="card-body">
                                            ...
                                            <img src="../../../../assets/bootstrap/assets/images/cat/05.png"
                                                class="position-absolute end-0 bottom-0" width="130" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="card rounded-4">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/16.png"
                        ...
                        <div class="card rounded-4">
                            <img src="../../../../assets/bootstrap/assets/images/gallery/17.png"
                                class="card-img rounded-4" alt="...">
                            <div class="card-img-overlay">
