                    ...
                    <div class="card w-100">
                        ...
                        <div class="customer-notes mb-3">
                            <div class="bg-light mx-3 my-0 rounded-3 p-3">
                                ...
                                <hr>
                                <div class="notes-item">
                                    <p class="mb-2">Contrary to popular belief, Lorem Ipsum is not simply random text.
                                        It has roots in a
                                ...
                                <hr>
                                <div class="notes-item">
                                    <p class="mb-2">On the other hand, we denounce with righteous indignation and
                                        dislike pleasure of the
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/06.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/05.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                                <div class="product-info">
                                                    <a href="javascript:;" class="product-title">Women Pink Floral
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/04.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                                <div class="product-info">
                                                    <a href="javascript:;" class="product-title">Women Pink Floral
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/03.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                                <div class="product-info">
                                                    <a href="javascript:;" class="product-title">Women Pink Floral
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/02.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                                <div class="product-info">
                                                    <a href="javascript:;" class="product-title">Women Pink Floral
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box">
                                                    <img src="../../../../assets/bootstrap/assets/images/top-products/01.png" width="55"
                                                        class="rounded-3" alt="">
                                                </div>
                                                <div class="product-info">
                                                    <a href="javascript:;" class="product-title">Women Pink Floral
