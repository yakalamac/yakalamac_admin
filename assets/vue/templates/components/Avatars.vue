        ...
        <div class="main-content">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/01.png" alt="Contact Person">John Doe
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/02.png" alt="Contact Person">Jessica Doe
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/03.png" alt="Contact Person">Michele Powa
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/04.png" alt="Contact Person">Clark Natela
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/05.png" alt="Contact Person">Anantu Painda <span
                            class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/06.png" alt="Contact Person">Tiger Xink <span class="closebtn"
                            onclick="this.parentElement.style.display='none'">×</span>
                    </div>
                    <div class="chip">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/07.png" alt="Contact Person">Salena Chain <span class="closebtn"
                            onclick="this.parentElement.style.display='none'">×</span>
                    </div>
                    <hr>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="chip chip-md bg-dark text-white">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/03.png" alt="Contact Person">Michele Powa <span class="closebtn"
                            onclick="this.parentElement.style.display='none'">×</span>
                    </div>
                    <div class="chip chip-md bg-danger text-white">
                        <img src="../../../../assets/bootstrap/assets/images/avatars/04.png" alt="Contact Person">Clark Natela <span class="closebtn"
                            onclick="this.parentElement.style.display='none'">×</span>
                    </div>
                    <hr>
