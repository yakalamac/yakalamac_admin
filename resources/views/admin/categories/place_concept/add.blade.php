...
@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Yeni Konsept Kategorisi</h5> <small class="text-muted float-end">Kaynak Yönetimi</small>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" name="title"
                               placeholder="Aspava Konsept" required/>
                        @error('text')
...
@section('js')
    ...
    <script src="{{asset('assets/public-js/view/place/concept-categories/add.js')}}" type="module" async></script>
@endsection
