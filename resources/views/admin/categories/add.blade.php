...
@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Yeni Kaynak Ekle</h5> <small class="text-muted float-end">Kaynak Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.categories.addPost') }}" method="post" enctype="multipart/form-data">
                @csrf
