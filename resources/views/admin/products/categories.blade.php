...
@section('title', 'Product Categories - Yaka.la')

@section('content')
    <div class="btns-wrapper float-start w-100 mb-4">
        <a href="{{ route('admin.products.addCategory') }}" class="btn rounded-pill btn-primary waves-effect waves-light"><i
                class="fa fa-plus"></i>&nbsp;&nbsp;Yeni Ürün Kategorisi Ekle</a>
    </div>
    ...
    <div class="card">
        <h5 class="card-header">Ürün Kategorileri</h5>
                ...
                <tbody class="table-border-bottom-0">
                    @forelse($categories as $category)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.products.editCategory', ['uuid' => $uuid[1]]) }}"><i
                                        class="ti ti-pencil me-1"></i></a>
                                <a href="{{ route('admin.products.deleteCategory', ['uuid' => $uuid[1]]) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="4">Ürün Kategorisi Bulunamadı</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
