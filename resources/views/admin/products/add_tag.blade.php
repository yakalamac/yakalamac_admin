...
@section('title', 'Add New Product Tag - Yaka.la')

@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Yeni Ürün Etiketi Ekle</h5> <small class="text-muted float-end">Ürün Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.products.addProductTag') }}" method="post">
                @csrf
