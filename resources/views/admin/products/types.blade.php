...
@section('title', 'Product Types - Yaka.la')

@section('content')
    <div class="btns-wrapper float-start w-100 mb-4">
        <a href="{{ route('admin.products.addType') }}" class="btn rounded-pill btn-primary waves-effect waves-light"><i
                class="fa fa-plus"></i>&nbsp;&nbsp;Yeni Ürün Türü Ekle</a>
    </div>
    ...
    <div class="card">
        <h5 class="card-header">Ürün Türleri</h5>
                ...
                <tbody class="table-border-bottom-0">
                    @forelse($types as $Type)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.products.editType', ['uuid' => $uuid[1]]) }}"><i
                                        class="ti ti-pencil me-1"></i></a>
                                <a href="{{ route('admin.products.deleteType', ['uuid' => $uuid[1]]) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="4">Ürün Türü Bulunamadı</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
