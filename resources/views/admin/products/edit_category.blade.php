...
@section('title', 'Edit Product Category - Yaka.la')

@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Ürün Kategorisi Düzenle</h5> <small class="text-muted float-end">Ürün Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.products.editProductCategory') }}" method="post">
                @csrf
