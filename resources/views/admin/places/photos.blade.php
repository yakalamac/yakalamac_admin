...
<div class="btns-wrapper float-start w-100 mb-4">
    <a href="{{ route('admin.places.addPhoto', ['uuid' => $place->uuid]) }}"
        class="btn rounded-pill btn-primary waves-effect waves-light"><i class="fa fa-plus"></i>&nbsp;&nbsp;Yeni
        Fotoğraf
        Ekle</a>
</div>
            ...
            <tbody class="table-border-bottom-0">
                @forelse($photos as $photo)
                    <tr>
                        ...
                        <td>
                            <img src="{{ $photo->src }}" alt="Fotoğraf" style="max-width: 100px; max-height: 100px;">
                        </td>
                        <td>
                            {{ $photo->width_px }}px
                        </td>
