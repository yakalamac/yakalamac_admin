...
@section('title', 'Add New Place Type - Yaka.la')

@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Yeni İşletme Türü Ekle</h5> <small class="text-muted float-end">İşletme Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.places.addPostType') }}" method="post">
                @csrf
