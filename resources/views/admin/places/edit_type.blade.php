...
@section('title', 'Edit Place Type - Yaka.la')

@section('content')
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">İşletme Türü Düzenle</h5> <small class="text-muted float-end">İşletme Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.places.editPostType') }}" method="post">
                @csrf
