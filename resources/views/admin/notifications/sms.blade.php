...
@section('title', 'SMS Notifications - Yaka.la')

@section('content')
    <div class="btns-wrapper float-start w-100 mb-4">
        <a href="{{ route('admin.notifications.addSms') }}" class="btn rounded-pill btn-primary waves-effect waves-light"><i
                class="fa fa-plus"></i>&nbsp;&nbsp;Yeni SMS Bildirimi Ekle</a>
    </div>
    ...
    <div class="card">
        <h5 class="card-header">SMS Bildirimleri</h5>
