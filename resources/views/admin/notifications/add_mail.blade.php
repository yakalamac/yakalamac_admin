...
@section('title', 'Add New Mail Notification - Yaka.la')
...
@section('content')
    ...
    <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Yeni Mail Bildirimi Ekle</h5> <small class="text-muted float-end">Bildirim Yönetimi</small>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.notifications.addPostMail') }}" method="post">
                @csrf
                <div class="row mb-6">
